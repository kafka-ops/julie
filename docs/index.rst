.. Julie Ops documentation master file, created by
   sphinx-quickstart on Sun May 31 09:05:19 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Julie Ops's documentation!
==================================================
...
To install Julie Ops and enable your teams to use a gitops approach when managing Apache Kafka you need:
...
If case you require any help regarding the usage or development of Julie Ops, don't hesitate to contact our `gitter community  <https://gitter.im/kafka-topology-builder/community#>`_.
