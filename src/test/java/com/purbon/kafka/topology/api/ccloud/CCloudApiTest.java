...
public class CCloudApiTest {
    ...
    public void testAclCreateMethod() throws IOException {
        ...
        TopologyAclBinding binding = new TopologyAclBinding("TOPIC",
                "foo",
                "*",
                "ALL",
                "User:foo",
    ...
    public void testAclDeleteMethod() throws IOException {
        ...
        var url = "http://not.valid:9999/kafka/v3/clusters/clusterId/acls?principal=User:foo&pattern_type=LITERAL&resource_type=TOPIC&host=*&permission=ALLOW&resource_name=foo&operation=ALL";
