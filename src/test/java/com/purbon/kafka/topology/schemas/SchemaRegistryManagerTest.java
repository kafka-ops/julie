...
public class SchemaRegistryManagerTest {
  ...
  public void shouldRegisterAndUpdateAvroSchema() throws Exception {
	...
	Path updatedSchemaFilePath =
		    Paths.get(getClass().getClassLoader().getResource("schemas/test-backward-compatible.avsc").toURI());
  ...
  @Test
  public void shouldDetectIncompatibleAvroSchema() throws URISyntaxException, IOException, RestClientException {
  ...
  public void shouldRegisterAndUpdateJsonSchema() throws Exception {
	...
	Path updatedSchemaFilePath =
		    Paths.get(getClass().getClassLoader().getResource("schemas/test-backward-compatible.json").toURI());
    final String updatedSampleSchema = new String(Files.readAllBytes(updatedSchemaFilePath));
  ...
  @Test
  public void shouldDetectIncompatibleJsonSchema() throws URISyntaxException, IOException, RestClientException {
	...
	Path updatedSchemaFilePath =
		    Paths.get(getClass().getClassLoader().getResource("schemas/test-forward-compatible.json").toURI());
    final String updatedSampleSchema = new String(Files.readAllBytes(updatedSchemaFilePath));
  ...
  public void shouldRegisterAndUpdateProtobufSchema() throws Exception {
	...
	Path updatedSchemaFilePath =
		    Paths.get(getClass().getClassLoader().getResource("schemas/test-backward-compatible.proto").toURI());
    final String updatedSampleSchema = new String(Files.readAllBytes(updatedSchemaFilePath));
  ...
  @Test
  public void shouldDetectIncompatibleProtobufSchema() throws URISyntaxException, IOException, RestClientException {
	...
	Path updatedSchemaFilePath =
		    Paths.get(getClass().getClassLoader().getResource("schemas/test-forward-compatible.proto").toURI());
    final String updatedSampleSchema = new String(Files.readAllBytes(updatedSchemaFilePath));
