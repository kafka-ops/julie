  ...
  public static String getVersion() {
    InputStream resourceAsStream =
        KafkaTopologyBuilder.class.getResourceAsStream(
            "/META-INF/maven/kafka.ops/kafka-topology-builder/pom.properties");
  ...
  private static BackendController buildStateProcessor(TopologyBuilderConfig config)
    ...
    try {
      if (stateProcessorClass.equalsIgnoreCase(
        ...
        String host = config.getProperty(TopologyBuilderConfig.REDIS_HOST_CONFIG);
        int port = Integer.parseInt(config.getProperty(TopologyBuilderConfig.REDIS_PORT_CONFIG));
